...
// Perf mode: never run the per-pixel palette-swap layers. Kept inside
// if (false) so the pal_swap_* function references survive (gmtoolkit
// mis-rebuilds the FUNC chain if the last call site is removed).
if (false)
{
